...
function shane_tm_background_animation(){
	...
	jQuery("body").on('mousemove', function(e){
		...
		background.css({
			"background-position": "calc( 50% + " + xCor + "px ) calc( 50% + " + yCor + "px )",
		});
...
function shane_tm_anchor(){
	...
	jQuery('.shane_tm_one_page_topbar ul li a,.shane_tm_mobile_menu .dropdown .dropdown_inner ul li a,.shane_tm_sidebar .inner .menu ul li a').off().on('click',function(e){
		e.stopPropagation();
		var element = jQuery(this);
...
function shane_tm_kenburn_slider(){
	...
	"use strict";
		...
		jQuery(function() {
			jQuery('.shane_tm_fixed_image .overlay_slider,.shane_tm_leftside .overlay_slider,.shane_tm_one_page_experience .overlay_slider,.shane_tm_sidebar_hero .overlay_slider').vegas({
			timer:false,	
...
function shane_tm_portfolio(){
	...
	if(jQuery().isotope) {
		...
		// Needed variables
		var list 		 = jQuery('.shane_tm_works .portfolio_list ul,.shane_tm_one_page_portfolio .portfolio_list ul');
		var filter		 = jQuery('.shane_tm_works .portfolio_filter ul,.shane_tm_one_page_portfolio .portfolio_filter ul');
